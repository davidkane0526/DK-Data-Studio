...
24. v3.38.0: add stable PortableView home-slot anchors, fix Resonance Group Auto/1–6 layout menu, and make the system Export menu dynamically follow the active SUPER plugin with semantic Resonance/Pulse/TER/Data Center targets.
