...
The machine-readable authoring corpus includes SDK 1.18.0 / Plugin API 1.18.0 contract JSON, manifest schema, TypeScript API definitions, UI/workspace/data-model guides and official plugin templates.
