...
The machine-readable authoring corpus includes SDK 1.23.0 / Plugin API 1.19.0 / Theme Contract 3.9.0 contract JSON, manifest schema, TypeScript API definitions, UI/workspace/data-model guides and official plugin templates.
