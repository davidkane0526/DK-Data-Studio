...
The machine-readable authoring corpus includes SDK 1.17.8 / Plugin API 1.17.0 contract JSON, manifest schema, TypeScript API definitions, UI/workspace/data-model guides and official plugin templates.
