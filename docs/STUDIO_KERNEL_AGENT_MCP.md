...
Version: DK Data Studio 3.61.50
...
The 3.61.50 kernel exposes these domains:
...
The machine-readable authoring corpus includes SDK 1.17.6 / Plugin API 1.17.0 contract JSON, manifest schema, TypeScript API definitions, UI/workspace/data-model guides and official plugin templates.
