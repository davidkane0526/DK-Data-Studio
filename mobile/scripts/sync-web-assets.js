...
fs.copyFileSync(requireFile('node_modules/plotly.js-cartesian-dist-min/plotly-cartesian.min.js'), path.join(vendor, 'plotly.min.js'));

const indexPath = path.join(out, 'index.html');
let html = fs.readFileSync(indexPath, 'utf8');
html = html
  .replace('../node_modules/d3/dist/d3.min.js', 'vendor/d3.min.js')
  .replace('../node_modules/plotly.js-cartesian-dist-min/plotly-cartesian.min.js', 'vendor/plotly.min.js')
