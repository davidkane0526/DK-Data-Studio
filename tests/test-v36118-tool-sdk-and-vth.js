...
const vthSource=read('examples/transfer-vth-lab/plugin.js');
assert(vthSource.includes('dkds-vth-field dkds-field')&&!/(?:background|color|border|box-shadow|font(?:-size)?)\s*:/.test(vthCss),'Vth numeric inputs must inherit Core field styling instead of private CSS chrome.');
