...
assert(touch.includes('--dkds-scientific-nav-item-width:28px;')&&touch.includes('--dkds-scientific-nav-item-height:28px;'),'Desktop scientific navigation must retain the restored 28x28 readable geometry.');
