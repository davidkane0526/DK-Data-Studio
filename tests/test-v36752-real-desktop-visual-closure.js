...
assert(touch.includes('--dkds-scientific-nav-item-width:25.2px;')&&touch.includes('--dkds-scientific-nav-item-height:25.2px;'),'Desktop scientific navigation must retain the accepted 25.2x25.2 geometry.');
