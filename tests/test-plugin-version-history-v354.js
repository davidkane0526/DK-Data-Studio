...
assert(pluginPackages.includes('archivePluginPackage(previousPackage,archiveReason)')&&main.includes('commitPluginInstall(plan'),'Plugin upgrade/rollback must archive the previous installed layer through the package runtime.');
