...
const ter=fs.readFileSync('src/plugins/ter-analysis/analysis-service.js','utf8');const resonance=fs.readFileSync('src/plugins/resonance-workbench/feature-peak-runtime.js','utf8');
