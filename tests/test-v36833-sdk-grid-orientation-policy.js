...
assert.strictEqual(sdk.sdkVersion,'1.28.0');assert.strictEqual(sdk.pluginApiVersion,'1.19.0');assert.strictEqual(sdk.minimumAppVersion,'3.68.36');
...
console.log('v3.68.36 SDK 1.28 managed-grid orientation policy contract PASS.');
