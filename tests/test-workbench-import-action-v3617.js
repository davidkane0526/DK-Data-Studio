...
assert(contract.pluginApiVersion==='1.18.0'&&contract.minimumAppVersion==='3.64.0','Current complete SDK contract must require app 3.64.0 while preserving older installed plugin-package compatibility.');
