...
assert(contract.pluginApiVersion==='1.18.0'&&contract.minimumAppVersion==='3.66.0','Current complete SDK contract must require app 3.65.8 while preserving older installed plugin-package compatibility.');
