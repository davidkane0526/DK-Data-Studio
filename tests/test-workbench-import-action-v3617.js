...
assert(contract.pluginApiVersion==='1.18.0'&&contract.minimumAppVersion==='3.65.1','Current complete SDK contract must require app 3.65.1 while preserving older installed plugin-package compatibility.');
