...
assert(resonanceView.includes('class="respar-detect-actions"')&&!resonanceView.includes('respar-detect-actions dkds-action-row'),
...
assert(!resonanceCss.includes('resonance-native-client')&&!resonanceView.includes('ctx.runtime.isNativeClient'),
