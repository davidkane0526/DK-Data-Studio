...
for(const dir of fs.readdirSync(path.join(root,'src/plugins'))){
  ...
  assert(['1.9.0','1.10.0','1.11.0','1.12.0','1.13.0','1.14.0','1.15.0','1.16.0','1.17.0'].includes(manifest.apiVersion),`${dir}: built-in manifest must use compatible API 1.9 through 1.17.`);
...
console.log('Core Plugin Contract v1.17 compatibility checks passed.');
