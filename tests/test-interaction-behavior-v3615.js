...
assert(manifest.apiVersion==='1.19.0','Resonance reference plugin must target Plugin API 1.19.0.');
...
assert(sdkContract.pluginApiVersion==='1.19.0','Standalone SDK must target the Plugin API 1.19 Legacy-Free contract.');
