...
assert.strictEqual(sha('src/plugins/transfer-vth-lab/plugin.css'),'b56cb70582da3102ee4d057349715db8707762d8702f377b660ebb3c5632d7ee','Vth shadow reconstruction must not modify production Vth CSS.');
...
assert(nativeCss.includes('--dkds-vth-results-height:180px')&&nativeCss.includes('@container vth-primary (max-width:920px)'),'Retired production CSS remains byte-frozen as source evidence for accepted pre-cutover geometry.');
