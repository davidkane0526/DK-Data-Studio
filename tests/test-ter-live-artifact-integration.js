...
(async()=>{
  ...
  const runtime=await terAnalysis.create({
    artifacts:store,science:Analysis,dataModel:D,pipeline,performance,algorithms,
  ...
  const result=await runtime.service.calculate();
