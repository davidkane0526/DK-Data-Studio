...
const index=read('src/index.html'),runtime=read('src/plugin-window/runtime.js'),manager=read('desktop/plugin-window-manager.js'),kernel=read('src/core/plugin-kernel.js'),contract=read('src/core/plugin-contract-runtime.js'),data=read('src/core/data-model.js'),automation=read('src/core/automation-test-runtime.js');
