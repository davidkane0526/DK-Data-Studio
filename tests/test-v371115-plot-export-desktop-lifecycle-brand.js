...
assert(chartRuntime.includes('function sourceData(target)')&&chartRuntime.includes('saveImage,sourceData,themeLayout'),'Scientific Chart Runtime must expose a logical source snapshot.');
