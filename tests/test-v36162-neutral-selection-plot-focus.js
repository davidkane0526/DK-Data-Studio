...
assert(modern.includes('background:var(--dkui-selection-bg,var(--dkui-accent-soft))!important'),'Dataset and linked-selection rows must consume the selection token.');
