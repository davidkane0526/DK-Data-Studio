...
for(const token of ['data-dkds-mobile-presentation="semantic"','data-dkds-mobile-region="drawer"','data-dkds-mobile-region="sheet"','data-dkds-mobile-region="companion-right"','data-dkds-mobile-region="companion-bottom"','data-dkds-mobile-region="route"'])assert(semanticCss.includes(token),`Presenter-driven semantic mobile CSS missing ${token}.`);
...
assert(!/\b(?:resonance|data-center)\b|[.#](?:ter|pulse)[-_]/i.test(shellCss+semanticCss),'Core mobile platform CSS must remain domain blind.');
