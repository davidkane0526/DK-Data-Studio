...
assert(touch.includes('--dkds-scientific-nav-item-width:20.16px;')&&touch.includes('--dkds-scientific-nav-item-height:25.2px;'),'Desktop ScientificPlot floating actions must be 20.16×25.2 after the accepted Desktop width reduction, not the former 18×11.5 pill.');
