...
assert(desktopTouch.includes('--dkds-scientific-nav-item-width:28px;')&&desktopTouch.includes('--dkds-scientific-nav-item-height:28px;'),'Desktop scientific chrome must remain unchanged.');
