...
assert(aurora.includes("version:'2.2.1'")&&aurora.includes("active:{surface:'#008B97',text:'#FFFFFF'")&&aurora.includes("selected:{surface:'#6F50FF',text:'#FFFFFF'")&&aurora.includes("active:{surface:'#07515B',text:'#E7FEFF'"),'Aurora filled interaction states must keep high-contrast white labels in both light and dark profiles.');
