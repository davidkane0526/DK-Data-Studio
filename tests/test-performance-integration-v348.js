...
assert(resonance.includes("live.pipelineRuntime.runSync('gate-analysis'")&&!resonance.includes('gateComputeCache={'),'resonance gate analysis must use the shared Scientific Pipeline contract');
