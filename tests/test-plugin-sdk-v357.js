...
assert(contract.pluginApiVersion==='1.19.0','SDK must target Plugin API 1.19.0.');
...
assert(sdkTypes.includes("apiVersion:'1.19.0'")&&sdkTypes.includes('DKDSPluginContext'),'SDK must ship editor-readable Plugin API declarations.');
...
assert(packages.includes('node sdk/tools/dkds-plugin.js validate')&&packages.includes('\"apiVersion\": \"1.19.0\"'),'Plugin package guide must document the standalone v1.19 SDK workflow.');
