...
let state={workspace:{groupColumns:'auto',peakDisplay:{showPoints:true,showRejected:false},peaks:[{id:'p1',sweepId:'s1',v:0.1,i:2,accepted:true,peakOrder:1,direction:1,primaryAlgorithm:'manual'},{id:'p2',sweepId:'s2',v:0.2,i:3,accepted:true,peakOrder:1,direction:1}]},datasets:[{id:'d1'}],sweeps:[{id:'s1',points:[{v:0.1,i:2}]},{id:'s2',points:[{v:0.2,i:3}]}],activeView:'main'};
const calls=[];
const service={
