...
const terView=read('src/plugins/ter-analysis/unit-presentation.js');
...
assert(terFeature.includes("const CHART_COUNT=7")&&terView.includes("plotId:'terTransformHeatmapPlot'")&&terView.includes('units.parameterForm.mount'),
  'TER transformed heatmap must be integrated into the seven-card Unit dashboard using the managed ParameterForm Unit');
