...
const valid=normalize({
  schema:1,
  manifest:{id:'lab.sdk-mobile',name:'SDK Mobile Lab',version:'1.0.0',apiVersion:'1.17.0',pluginType:'workbench',entry:'plugin.js',styles:['style.css']},
...
assert.throws(()=>normalize({schema:1,manifest:{id:'lab.bad',name:'Bad',version:'1.0.0'},files:{'../plugin.js':''}}),/Unsafe plugin file path/);
assert.throws(()=>normalize({schema:1,manifest:{id:'builtin.bad',name:'Bad',version:'1.0.0'},files:{'plugin.js':''}}),/reserved plugin id/);
assert.throws(()=>normalize({schema:1,manifest:{id:'lab.tool',name:'Tool',version:'1.0.0',pluginType:'tool'},files:{'plugin.js':''}}),/workspace\.role=top/);
