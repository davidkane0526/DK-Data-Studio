...
assert(css.includes('--dkds-scientific-nav-item-width:25px')&&css.includes('--dkds-scientific-nav-item-height:24px')&&css.includes('--dkds-header-action-height:var(--dkds-scientific-nav-item-height)')&&css.includes('width:var(--dkds-scientific-nav-item-width)'),'Both scientific navigation runtimes must share the same slot-owned compact 25x24 hit-region geometry.');
