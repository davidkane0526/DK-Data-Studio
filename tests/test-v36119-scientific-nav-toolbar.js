...
assert(sdk.pluginApiVersion==='1.18.0'&&sdk.minimumAppVersion==='3.63.0','Internal D3 navigation polish must not change the Plugin SDK current SDK contract and hardened host minimum.');
