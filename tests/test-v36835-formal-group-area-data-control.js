...
assert.strictEqual(sdk.sdkVersion,'1.28.0');assert.strictEqual(sdk.minimumAppVersion,'3.68.36');
...
console.log('v3.68.36 formal GroupArea + Mobile data-control/header/height contract PASS.');
