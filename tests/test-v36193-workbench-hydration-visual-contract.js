...
assert(!dataCenter.includes('ctx.ui.workspaceSurface.create')&&dataCenterMobile.includes("wb.compose({")&&dataCenterMobile.includes("id:'data-control'")&&dataCenterMobile.includes("presentationRole:'data-control'")&&!dataCenterMobile.includes("layout.className='dc-workspace-layout'"),
  'Data Center Desktop must preserve its established static composition while the SDK 1.25 Mobile platform presenter publishes the data rail as a semantic data-control PRIME.');
