...
assert(superTop.includes('position:var(--dkds-portable-floating-position,fixed)')&&superTop.includes('overflow:var(--dkds-portable-fill-overflow,var(--dkds-portable-docked-overflow,hidden))'), 'Portable placement final properties must consume --dkds-portable-* slots.');
