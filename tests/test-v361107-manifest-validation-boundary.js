...
let missing='';
try{P.define({id:'test.missing-type',name:'Missing Type',version:'1.0.0',apiVersion:'1.19.0'},async()=>({}));}catch(err){missing=String(err.message||err);}
