...
assert(workspaceCss.includes('data-dkds-mobile-region="drawer"')&&workspaceCss.includes('max-width:min(88vw,680px)')&&!workspaceCss.includes('@keyframes dkds-native-drawer-in'),'Mobile Parameters must remain a stable semantic drawer with bounded content-fit width and no replayed slide animation.');
