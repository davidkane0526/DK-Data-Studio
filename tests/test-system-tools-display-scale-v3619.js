...
assert(json('sdk/contract.json').pluginApiVersion==='1.18.0','Standalone SDK must publish Plugin API 1.16.');
...
const main=read('desktop/main.js'),preload=read('desktop/preload.js');
