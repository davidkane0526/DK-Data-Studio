...
assert(renderer.includes("const VERSION='3.10.0'")&&renderer.includes('materialContexts:true'));
const component=read('src/core/theme/component-appearance.js');
assert(component.includes("const VERSION='3.0.0'")&&component.includes('ThemeContract.resolveComponentAppearance'));
