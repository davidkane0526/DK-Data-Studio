...
const css=read('src/styles/presentation/dialogs.css');
...
assert(/:is\(:hover,:active,:focus-visible\)\s*\{\s*transform:none/.test(css),'menu items must not lift on hover/press');
