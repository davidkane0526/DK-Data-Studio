...
const modules=[
  'feature-context.js','feature-group-runtime.js','feature-analysis-runtime.js','feature-peak-runtime.js',
...
for(const token of [
  ...
  'let interactionRuntime=null','let interactionSelection=null','let detectorRuntime=null','let peakMetricCache=new WeakMap()',
...
for(const token of ['let detectorRuntime=null','let peakMetricCache=new WeakMap()','runDetection','detectRange','peakMetrics','commitPeakMetricEdit'])
