...
assert(semanticCss.includes('.dkds-panel-close-button')&&integrated.includes('body.dkds-modern-ui .dkds-panel-close-button{'),'Core must expose one close-button geometry and appearance contract.');
