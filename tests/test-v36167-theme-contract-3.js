...
assert(theme.includes("version:'3.6.0'"),'Theme Runtime must expose the strict Theme Contract 3.6 runtime.');
...
console.log('Theme Contract 3.6 plugin/runtime semantics checks passed.');
