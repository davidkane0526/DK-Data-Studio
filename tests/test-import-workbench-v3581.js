...
const automation=(fs.readFileSync(path.join(root,'src','diagnostics','automation-test-runtime.js'),'utf8')+fs.readFileSync(path.join(root,'src','diagnostics','automation-smoke-cases.js'),'utf8'));
