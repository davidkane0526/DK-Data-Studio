...
const window={d3:{},DKDSTheme:{subscribeRevision(){return()=>{};}},DKDSD3Renderer:{supports:()=>true,react(el,data,layout,config){captured={el,data,layout,config};el.data=data;el.layout=layout;el.dataset.dkdsChartRenderer='d3';return Promise.resolve(el);},restyle(){return Promise.resolve(true);},relayout(){return Promise.resolve(true);},resize(){return true;},purge(){return true;},toImage(){return Promise.resolve('');}}};
