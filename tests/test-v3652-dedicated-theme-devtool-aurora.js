...
for(const token of ['#statusBar.statusbar .plugin-status-item:is(:hover,:focus-visible)', 'background:transparent', 'box-shadow:none'])assert(integrated.includes(token),`quiet status-bar hover missing ${token}`);
