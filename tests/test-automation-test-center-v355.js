...
assert(runtime.includes("'algorithms.package-catalog'")&&runtime.includes('Algorithm Package Catalog & readiness'),'Built-app automation must validate current Algorithm Package Catalog readiness/indexing.');
