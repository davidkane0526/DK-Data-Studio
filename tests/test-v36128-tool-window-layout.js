...
assert.equal(pkg.version,'3.61.93','Tool window/layout release must be v3.61.32');
...
assert(/\.analysis-page\{[\s\S]*?bottom:28px/.test(pluginWindow),'AnalysisPage must remain the single viewport reservation above the fixed status bar');
