...
assert(navigation.includes('[data-dkds-presentation-compact="true"]{\n  width:48px;min-width:48px;max-width:48px;padding:0;line-height:34px;text-align:center;'),'Compact presentation commands must center short labels in the full 48 px hit box.');
