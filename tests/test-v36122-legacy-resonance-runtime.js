...
vm.runInContext(read('src/plugins/resonance-workbench/inspector-detail-projection.js'),context,{filename:'inspector-detail-projection.js'});
vm.runInContext(read('src/plugins/resonance-workbench/feature-inspector-mutation-runtime.js'),context,{filename:'feature-inspector-mutation-runtime.js'});
...
(async()=>{
  ...
  const dataRuntimeSource=read('src/plugins/resonance-workbench/feature-data-runtime.js');
  ...
  assert(runtimeSource.includes("require('builtin.resonance-workbench','feature-data-runtime')")&&dataRuntimeSource.includes('transportDatasetsFromArtifacts')&&dataRuntimeSource.includes("consumer:'builtin.resonance-workbench'")&&manifest.scripts.includes('feature-data-runtime.js'),'Canonical Artifact-backed Resonance datasets must preserve the scoped assignment boundary through the dedicated data owner loaded before feature-runtime.');
