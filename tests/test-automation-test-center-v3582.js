...
for(const token of ["'data.sources.lifecycle'",'Project source data lifecycle','dataSourceLifecycleSmoke',"get?.('core.data-sources')",'api.remove(id)'])assert(runtime.includes(token),`Automation source lifecycle coverage missing: ${token}`);
