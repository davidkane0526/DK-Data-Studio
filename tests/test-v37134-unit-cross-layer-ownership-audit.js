...
assert(pulse.includes("variant:'identity',className:'pulse-control-grid'")&&pulse.includes("gridTemplateColumns:'repeat(2,minmax(0,1fr))'"),'Pulse parameter grid must express its fluid two-column accepted detail through one generic Layout Unit owner.');
