...
console.log(`v3.61.101 automation diagnostics modularization PASS: cases=${bytes('src/diagnostics/automation-smoke-cases.js')} B, runner=${bytes('src/diagnostics/automation-test-runtime.js')} B.`);
