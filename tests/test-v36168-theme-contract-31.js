...
assert(theme.includes("version:'3.10.0'"),'Theme Runtime must expose the strict 3.6 contract.');
...
assert(materialCss.includes('data-dkds-material-recipe=\"soft-glass\"')&&materialCss.includes('data-dkds-material-recipe=\"liquid-glass\"')&&materialCss.includes('radial-gradient(circle at 1px 1px')&&materialCss.includes('--dkds-material-theme-overlay'),'Core must own reusable material recipes including noise composition.');
...
console.log('Theme Contract 3.8 canonical material checks passed.');
