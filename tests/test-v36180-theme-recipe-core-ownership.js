...
assert(runtime.includes("canvas:'#F4F7FB'"),'Thin Glass light canvas hierarchy token missing.');
assert(runtime.includes("surface:'#FFFFFF'")&&runtime.includes("surfaceSidebar:'rgba(248,250,252,.44)'"),'Thin Glass light surface hierarchy must match the public SDK visual family.');
