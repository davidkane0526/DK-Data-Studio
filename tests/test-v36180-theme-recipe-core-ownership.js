...
assert.equal(json('sdk/contract.json').sdkVersion,'1.21.2');
...
assert(sdkReadme.includes('SDK 1.21.2'),'SDK README must describe the current Theme authoring baseline.');
