...
assert(dedicated.includes("if(requestedIds.includes('scientific-renderer'))ordered.push('d3')")&&dedicated.includes("'scientific-display-runtime'")&&dedicated.includes("'heatmap-canvas-runtime'")&&dedicated.includes("preferredRenderer:'d3',host:'dedicated-top'"),'Dedicated windows must resolve scientific-renderer to the D3 backend with shared display/raster Core dependencies.');
