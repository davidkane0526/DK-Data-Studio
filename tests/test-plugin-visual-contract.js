...
for(const [pluginCss,classes] of [[dataCenterCss,['.dc-inline-actions']],[pulseCss,['.pulse-file-toolbar','.pulse-table-actions']],[terCss,['.ter-chart-actions']]]){
...
assert(dataCenterViews.includes('dkds-surface-tabs'),'Data Center tab layout must consume the generic Core surface-tabs contract instead of a plugin-owned visual primitive.');
