...
const PYTHON_FILES=['dkds_source_import.py','dkds_source_workflow.py','dkds_table_transform.py','dkds_table_transform_task.py','dkds_plugin_gen.py','dkds_portable_task.py'];
