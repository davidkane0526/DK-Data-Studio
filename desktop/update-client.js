...
class LanUpdateClient extends EventEmitter {
  ...
  configureUpdater(feedUrl) {
    ...
    // Project/data safety: downloading may be automatic, installing never is.
    // A normal application quit must not launch an NSIS replacement/uninstall
    // transaction. Installation only happens through the explicit Install action.
