(() => {
  ...
  if(!modules?.define)throw new Error('Plugin Module Runtime unavailable.');
  ...
  modules.define('com.dkds.transfer-vth-lab','analysis-runtime',Object.freeze({finite,num,clone,defaults,pointsOfArtifact,findTurn,branches,regress,analyzeSegment,analyzeCurve}));
})();
