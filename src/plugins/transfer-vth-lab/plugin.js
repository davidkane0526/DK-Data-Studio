(() => {
  const manifest={
    id:'com.dkds.transfer-vth-lab',name:'Transfer Curve Vth Lab',version:'3.0.3',apiVersion:'1.17.0',entry:'plugin.js',scripts:['plugin.js'],styles:['plugin.css'],enabled:true,order:420,
