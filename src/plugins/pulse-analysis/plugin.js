(() => {
  DKDSPlugins.define({id:'builtin.pulse-analysis',pluginType:'workbench',name:'Pulse / Read Analysis',version:'2.10.8',apiVersion:'1.19.0',requiresCore:["runtime","events","status","io","science","services","modules","project","workspace","data.types","data.artifacts","data.sources","data.importers","analysis.providers","charts","ui.dom","ui.workspace","ui.plot-views","ui.actions","ui.selection","ui.interaction","ui.menus","ui.activities","ui.top-workspace","ui.pages","ui.portable","ui.scientific-plot"],pluginDependencies:[{id:'builtin.scientific-data-contracts',range:'^1.0.0'}],
    description:'Pulse/read Controller + Shared Views + Feature Runtime using common workbench infrastructure.',source:'builtin',order:140,capabilities:["ui.activity", "ui.page", "analysis.pulse", "project.slice", "chart.timeseries", "ui.top-workspace",  "ui.portable",  "ui.shortcuts",  "ui.selection", "ui.context-menu",'ui.interaction','data.types','data.sources','ui.plugin-workspace','ui.scientific-plot'],workspace:{role:'top',activity:'pulse',icon:'▥',title:'脉冲分析'},data:{accepts:['science.pulse.trace']}},async ctx=>{
