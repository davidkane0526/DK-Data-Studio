(() => {
  DKDSPlugins.define({id:'builtin.pulse-analysis',pluginType:'workbench',name:'Pulse / Read Analysis',version:'2.10.8',apiVersion:'1.18.0',requiresCore:["runtime","events","status","io","science","services","modules","project","workspace","data.types","data.artifacts","data.sources","data.importers","analysis.providers","charts","ui.dom","ui.workspace","ui.plot-views","ui.actions","ui.selection","ui.interaction","ui.menus","ui.activities","ui.top-workspace","ui.pages","ui.portable","ui.scientific-plot"],pluginDependencies:[{id:'builtin.scientific-data-contracts',range:'^1.0.0'}],
