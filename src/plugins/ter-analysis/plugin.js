(() => {
  DKDSPlugins.define({
    ...
    capabilities:["ui.activity", "ui.page", "analysis.ter", "chart.heatmap", "chart.transformed-heatmap", "chart.resistance-voltage", "ui.linked-selection", "ui.sticky-inspector", "ui.chart-layout", "ui.keyboard-adjustment", "chart.export", "ui.top-workspace",  "ui.portable",  "ui.shortcuts",  "ui.selection", "ui.context-menu",'ui.interaction','data.types','data.artifacts','data.pipeline','ui.plugin-workspace','ui.scientific-plot'],
