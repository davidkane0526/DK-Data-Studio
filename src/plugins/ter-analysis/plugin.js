(() => {
  DKDSPlugins.define({
    id:'builtin.ter-analysis',name:'TER Analysis',version:'3.3.0',apiVersion:'1.8.0',requiresCore:["runtime","events","status","io","science","services","modules","project","workspace","data.artifacts","data.types","analysis.providers","charts","parameters","ui.dom","ui.workspace","ui.plot-views","ui.actions","ui.selection","ui.interaction","ui.menus","ui.activities","ui.top-workspace","ui.shortcuts","ui.pages","ui.styles","ui.portable","ui.scientific-plot"],
