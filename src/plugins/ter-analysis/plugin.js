(() => {
  DKDSPlugins.define({
    ...
    source:'builtin',
    order:120,
    capabilities:['ui.activity','ui.page','analysis.ter','chart.heatmap','ui.top-workspace'],
    ...
    ctx.ui.topWorkspace.register({
      ...
      layout:{
        mode:'split',root:{selector:'.analysis-page-body'},
        left:{role:'data-display',pageId:page.id,selectors:['.ter-controls','.analysis-note','.heatmap-display-controls'],stack:true,defaultFraction:0.20,minFraction:0.14,maxFraction:0.42},
        main:{role:'primary-data',pageId:page.id,selector:'.ter-chart-grid',interaction:'plugin-owned'},
        prime:[]
      }
    });
