...
<table class="analysis-table" id="spacingTable"></table>
  ...
  const TOP_STYLES=`
    ...
    #resonanceDedicatedPage .reswin-group-grid{--reswin-group-cols:3;display:grid;grid-template-columns:repeat(var(--reswin-group-cols),minmax(0,1fr));gap:12px;align-items:start;width:100%}#resonanceDedicatedPage .reswin-group-card{border:1px solid var(--border-subtle);border-radius:8px;overflow:hidden;background:var(--surface-primary);min-width:0;display:grid;grid-template-rows:auto minmax(210px,var(--reswin-group-height,240px))}#resonanceDedicatedPage .reswin-group-head{min-height:34px;height:auto;padding:5px 8px;box-sizing:border-box;font-size:12px;font-weight:650;background:var(--surface-secondary);display:flex;justify-content:space-between;align-items:center;gap:8px}#resonanceDedicatedPage .reswin-group-head button{min-height:24px;height:24px;box-sizing:border-box;padding:2px 6px;font-size:11px;display:inline-flex;align-items:center;justify-content:center}
