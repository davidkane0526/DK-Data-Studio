(() => {
  ...
  function create({live={},services={},actions={},utils={}}={}){
    const liveView={};
    for(const name of [
      'workspace','project','datasets','analysisDatasets','sweeps','selectedPeakId','selectedSweepId','selectedRange','interactionRuntime','interactionSelection','workspaceNavigator',
      'sharedController','algorithmRuntime','pipelineRuntime','reactiveRuntime',
      'uiRuntime','workspaceRuntime','peakMetricRevision','peakMetricSettledRevision'
    ]){
