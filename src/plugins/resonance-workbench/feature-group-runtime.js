(() => {
  function create(context){
    ...
    return Object.freeze({render:renderGroup,dispose:disposeGroupViews,invalidate,state,contextText:groupContextText,effectiveColumns:()=>effectiveGroupColumns(),orientation:groupOrientation,syncLayout:syncGroupLayout,applyLayout:()=>syncGroupLayout({apply:true,force:true})});
  }
