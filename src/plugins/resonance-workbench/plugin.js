(() => {
  DKDSPlugins.define({
    ...
    version:'3.51.0',
    apiVersion:'1.8.0',requiresCore:["runtime","events","status","io","science","performance","services","modules","capabilities","project","workspace","parameters","data.artifacts","data.entities","data.types","data.pipeline","data.transforms","analysis.detectors","charts","ui.dom","ui.workspace","ui.actions","ui.selection","ui.interaction","ui.menus","ui.context-menus","ui.activities","ui.top-workspace","ui.toolbar","ui.shortcuts","ui.pages","ui.styles","ui.edit","ui.scientific-plot"],
    ...
    if(!ctx.runtime.isAuxiliaryWindow){
      ...
      runtime=await feature.createTop({
        ...
        io:ctx.io,charts:ctx.ui.scientificPlot,dom:ctx.ui.dom,performance:ctx.performance,pipeline:ctx.data.pipeline,transforms:ctx.data.transforms,
