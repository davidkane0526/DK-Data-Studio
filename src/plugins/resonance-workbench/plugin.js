(() => {
  DKDSPlugins.define({
    ...
    source:'builtin',
    order:100,
    capabilities:['ui.activity','ui.sidebar','ui.inspector','ui.group-charts','ui.main-tools','analysis.resonance','chart.trend','ui.top-workspace','ui.prime','ui.sub'],
...
<table class="analysis-table" id="spacingTable"></table>
    ...
    ctx.ui.sub.register('physics',{activity:'resonance',label:'物理机制',kind:'panel',target:'physicsPanel'});
    ctx.ui.sub.register('spacing',{activity:'resonance',label:'峰间分析',kind:'page',target:'spacingPage'});
    ctx.ui.sub.register('gate-analysis',{activity:'resonance',label:'栅压分析',kind:'page',target:'gateAnalysisPage'});
