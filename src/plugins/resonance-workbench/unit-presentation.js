(() => {
  ...
  function mount(ctx,controller,{mode='top'}={}){
    const dom=ctx.ui.dom,units=ctx.ui.unitTemplates,R=controller.service,isTop=mode==='top'||ctx.runtime.isAuxiliaryWindow;
