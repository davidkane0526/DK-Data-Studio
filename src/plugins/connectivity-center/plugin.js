(() => {
  ...
  DKDSPlugins.define({
    ...
    const setBusy=async(sel,fn)=>{const button=$(sel);if(button)button.disabled=true;try{return await fn();}finally{if(button)button.disabled=false;}};
