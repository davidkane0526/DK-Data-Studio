(() => {
  GRSPlugins.define({
    ...
    source:'builtin',
    order:20,
    capabilities:['data.model','data.formula','workflow.processor','workflow.analyzer','workflow.recipe','chart.renderer','ui.page','project.slice']
  }, async ctx => {
      ...
      html:`
        ...
        <div class="analysis-page-body data-center-body">
          <aside class="dc-card dc-artifact-pane">
            <div class="dc-section-head"><div><strong>数据对象</strong><span id="dcArtifactCount">0</span></div><button id="dcRefreshArtifacts">刷新</button></div>
