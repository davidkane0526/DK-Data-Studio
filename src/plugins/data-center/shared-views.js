(() => {
  const PAGE_HTML=`
        ...
        <div class="analysis-page-body data-center-body">
          ...
          <main class="dc-main">
            <section class="dc-card dc-source-preview"><div class="dc-section-head"><div><strong id="dcActiveName">未选择数据</strong><span id="dcActiveMeta">—</span></div><div class="dc-preview-actions"><div class="dc-tabs"><button data-dc-tab="formula" class="active">公式</button><button data-dc-tab="workflow">工作流</button><button data-dc-tab="provenance">来源链</button></div><button id="dcRemoveSource" class="danger-soft" disabled>移除源数据</button></div></div><div id="dcTablePreview" class="dc-table-preview"></div></section>
