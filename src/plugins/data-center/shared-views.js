        ...
        <div class="analysis-page-body data-center-body">
          <aside class="dc-card dc-artifact-pane dkds-surface">
            ...
            <div class="dc-filter-stack">
              ...
              <div class="dc-selection-tools" data-dkds-mobile-width-critical data-dkds-tooltip="移动端可开启多选；桌面端仍支持 Shift / Ctrl / Cmd"><button id="dcMultiSelectBtn" type="button" aria-pressed="false">多选</button><button id="dcSelectAllBtn" type="button">全选</button><button id="dcInvertSelectionBtn" type="button">反选</button><button id="dcClearSelectionBtn" type="button">清除</button></div>
            </div>
