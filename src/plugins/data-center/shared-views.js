(() => {
  ...
  function attach(ctx,page){
    ...
    return ctx.ui.workbench.create(shell,{existing:true,regions:{left:{target:'.dc-artifact-pane'},main:{target:'.dc-main'},right:{target:'.dc-main'},bottom:{target:'.dc-main'},overlay:{target:()=>page.querySelector('.analysis-page-body')||page}},split:ctx.host.isAuxiliaryWindow?{id:'data-center-local-left',region:'left',mainRegion:'main',defaultSize:290,min:220,reserve:520}:null});
  }
