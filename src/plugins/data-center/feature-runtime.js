(() => {
  async function mount(ctx,controller=null,views=null,adapter={}){
    ...
    function renderAllUi(){renderArtifacts();renderPreview();renderFormula();refreshProviderSelect();renderSteps();renderSavedRecipes();renderProvenance();renderChartControls();dom.frame(()=>{try{ctx.ui.scientificPlot.resize($('#dcChart'));}catch{}});}
