(() => {
  const manifest={
    id:'com.dkds.theme.liquid-glass',name:'Thin Glass',version:'1.8.1',apiVersion:'1.18.0',pluginType:'theme',
  ...
  DKDSPlugins.define(manifest,async ctx=>{
    ...
    if(missing.length)throw new Error(`Thin Glass 1.8.1 requires Theme Contract 3.6 thin-glass support: ${missing.join(', ')}`);
