DKDSPlugins.define({
  ...
  if(missing.length){
    throw new Error(`Aurora Pop 2.1.1 requires Theme Contract 3.9 features: ${missing.join(', ')}; host provides ${ctx.ui.theme.contractVersion}`);
  }
    ...
    modes:{
      light:{
        ...
        appearance:{
          ...
          components:{
            tab:{
              surface:'transparent',surfaceHover:'#E8E1FF',surfaceActive:'#00818D',surfaceSelected:'#D2C6FF',
              text:'#596176',textSoft:'#858CA0',textActive:'#FFFFFF',textSelected:'#4026A8',
            ...
            toolbarAction:{
              surface:'transparent',surfaceHover:'#E1EAFF',surfaceActive:'#00818D',surfaceSelected:'#D8CDFF',
              text:'#4F586D',textActive:'#FFFFFF',textSelected:'#4026A8',
      ...
      dark:{
        ...
        appearance:{
          ...
          components:{
            tab:{
              surface:'transparent',surfaceHover:'#281E4D',surfaceActive:'#087A84',surfaceSelected:'#493083',
            ...
            toolbarAction:{
              surface:'transparent',surfaceHover:'#143054',surfaceActive:'#087A84',surfaceSelected:'#3B276C',
