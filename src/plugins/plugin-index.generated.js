...
window.DKDS_BUILTIN_PLUGINS = [
  {
    ...
    "entry": "plugins/connectivity-center/plugin.js",
    "scripts": [
      "plugins/connectivity-center/plugin.js"
    ],
    "manifest": {
      "id": "builtin.connectivity-center",
      ...
      "enabled": true,
      "order": 34,
      "description": "Unified Studio connectivity center for provider files, SMB, full-kernel AI Agent and deep MCP server.",
      "capabilities": [
        "ui.activity",
        "ui.page",
        "files.provider-directory",
        "network.smb",
        "ai.agent.kernel",
        "mcp.kernel-server"
      ],
