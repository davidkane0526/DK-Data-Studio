...
const {runCommand,commandList,commandGet,commandHistory,replayCommand}=require('./commands/toolbar');
...
回滚错误：${rollbackError?.stack||rollbackError}`,detailLabel:'技术详情',detailOpen:true};throw combined;}
  ...
  window.DKDSPlugins = {
    ...
    commands: { run: runCommand, list:commandList, get:commandGet, history:commandHistory, replay:replayCommand },
    edit: {
