(() => {
  ...
  const ROLE_AREAS=Object.freeze([
    ...
    {id:'floating',label:'Floating Surfaces / Tool Panels',role:'floating',selector:'.dkds-floating-surface,.floating-panel:not(.lan-web-panel),.dkds-prime-floating,.dkds-memory-panel,.zoom-panel,.dkds-portable-view.is-floating,.dkds-portable-view.is-global-floating,.dkds-material-role-floating'}
  ]);
