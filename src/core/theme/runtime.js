(() => {
  ...
  profiles.set('builtin.thin-glass',normalizeProfile('builtin.thin-glass',{
    ...
    modes:{
      light:{tokens:{canvas:'#F4F7FB',surface:'#FFFFFF',surfaceSoft:'rgba(248,250,252,.84)',surfaceHover:'#EFF6FF',surfaceElevated:'rgba(255,255,255,.42)',surfaceSidebar:'rgba(248,250,252,.44)',controlBg:'#FFFFFF',controlHover:'#F1F5F9',divider:'rgba(148,163,184,.48)',dividerHover:'rgba(100,116,139,.66)',controlBorder:'#CBD5E1',controlBorderHover:'#94A3B8',scrollbar:'rgba(148,163,184,.30)',scrollbarHover:'rgba(100,116,139,.44)',text:'#1E293B',textSoft:'#475569',muted:'#64748B',accent:'#2563EB',accentHover:'#1D4ED8',accentSoft:'rgba(37,99,235,.08)',focus:'rgba(37,99,235,.15)',shadow1:'0 1px 4px rgba(100,116,139,.07)',shadow2:'0 4px 14px rgba(100,116,139,.09)',shadowFloat:'0 6px 18px rgba(100,116,139,.12),0 1px 4px rgba(100,116,139,.09)',radius:10,radiusLg:13},material:{glassEdge:'rgba(203,213,225,.72)',roles:{chrome:{glassEdge:'rgba(203,213,225,.70)'},sidebar:{glassEdge:'rgba(203,213,225,.68)'},elevated:{glassEdge:'rgba(203,213,225,.76)'},popover:{glassEdge:'rgba(203,213,225,.88)'},floating:{glassEdge:'rgba(203,213,225,.80)'}}}},
      dark:{tokens:{canvas:'#0B1020',surface:'#111827',surfaceSoft:'rgba(17,24,39,.80)',surfaceHover:'#1E293B',surfaceElevated:'rgba(23,32,51,.42)',surfaceSidebar:'rgba(15,23,42,.38)',controlBg:'#0F172A',controlHover:'#1E293B',divider:'rgba(71,85,105,.56)',dividerHover:'rgba(100,116,139,.72)',controlBorder:'#334155',controlBorderHover:'#475569',scrollbar:'rgba(71,85,105,.42)',scrollbarHover:'rgba(100,116,139,.58)',text:'#E2E8F0',textSoft:'#CBD5E1',muted:'#94A3B8',accent:'#2563EB',accentHover:'#60A5FA',accentSoft:'rgba(37,99,235,.13)',focus:'rgba(96,165,250,.18)',shadow1:'0 1px 4px rgba(0,0,0,.08)',shadow2:'0 4px 14px rgba(0,0,0,.11)',shadowFloat:'0 6px 18px rgba(0,0,0,.14),0 1px 4px rgba(0,0,0,.08)',radius:10,radiusLg:13},material:{glassEdge:'rgba(71,85,105,.64)',roles:{chrome:{glassEdge:'rgba(51,65,85,.68)'},sidebar:{glassEdge:'rgba(51,65,85,.66)'},elevated:{glassEdge:'rgba(71,85,105,.68)'},popover:{glassEdge:'rgba(71,85,105,.82)'},floating:{glassEdge:'rgba(71,85,105,.72)'}}}}
    }
  }));
