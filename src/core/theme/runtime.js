(() => {
  ...
  profiles.set('builtin.thin-glass',normalizeProfile('builtin.thin-glass',{
    ...
    modes:{
      light:{tokens:{canvas:'#E8EEF5',surface:'#F7F9FC',surfaceSoft:'rgba(235,241,247,.86)',surfaceHover:'#E5EDF7',surfaceElevated:'rgba(252,253,255,.74)',surfaceSidebar:'rgba(226,235,245,.82)',controlBg:'rgba(247,250,253,.74)',controlHover:'rgba(235,242,249,.88)',divider:'rgba(104,121,144,.14)',dividerHover:'rgba(73,94,122,.28)',controlBorder:'rgba(104,121,144,.22)',controlBorderHover:'rgba(73,94,122,.36)',scrollbar:'rgba(113,128,150,.30)',scrollbarHover:'rgba(82,101,128,.46)',text:'#172033',textSoft:'#33445B',muted:'#586A82',accent:'#2563EB',accentHover:'#1D4ED8',accentSoft:'rgba(37,99,235,.11)',focus:'rgba(37,99,235,.18)',shadow1:'0 0 0 1px rgba(101,116,139,.045),0 2px 7px rgba(69,84,110,.08)',shadow2:'0 0 0 1px rgba(101,116,139,.05),0 5px 16px rgba(69,84,110,.10)',shadowFloat:'0 0 0 1px rgba(101,116,139,.06),0 8px 22px rgba(69,84,110,.13)',radius:10,radiusLg:13},material:{glassEdge:'rgba(203,213,225,.30)',roles:{chrome:{glassEdge:'rgba(203,213,225,.28)'},sidebar:{glassEdge:'rgba(203,213,225,.24)'},elevated:{glassEdge:'rgba(203,213,225,.34)'},popover:{glassEdge:'rgba(203,213,225,.42)'},floating:{glassEdge:'rgba(203,213,225,.36)'}}}},
      dark:{tokens:{canvas:'#0A1020',surface:'#111827',surfaceSoft:'rgba(20,29,45,.78)',surfaceHover:'#1C293B',surfaceElevated:'rgba(27,38,58,.54)',surfaceSidebar:'rgba(13,22,39,.60)',controlBg:'rgba(16,25,43,.78)',controlHover:'rgba(29,42,61,.88)',divider:'rgba(100,116,139,.15)',dividerHover:'rgba(125,142,166,.30)',controlBorder:'rgba(100,116,139,.24)',controlBorderHover:'rgba(125,142,166,.40)',scrollbar:'rgba(71,85,105,.38)',scrollbarHover:'rgba(100,116,139,.56)',text:'#E6ECF4',textSoft:'#CBD5E1',muted:'#96A5B9',accent:'#3B74FF',accentHover:'#72AAFF',accentSoft:'rgba(59,116,255,.17)',focus:'rgba(114,170,255,.22)',shadow1:'0 0 0 1px rgba(148,163,184,.055),0 2px 8px rgba(0,0,0,.20)',shadow2:'0 0 0 1px rgba(148,163,184,.065),0 5px 16px rgba(0,0,0,.24)',shadowFloat:'0 0 0 1px rgba(148,163,184,.075),0 8px 24px rgba(0,0,0,.28)',radius:10,radiusLg:13},material:{glassEdge:'rgba(100,116,139,.28)',roles:{chrome:{glassEdge:'rgba(100,116,139,.24)'},sidebar:{glassEdge:'rgba(100,116,139,.22)'},elevated:{glassEdge:'rgba(100,116,139,.30)'},popover:{glassEdge:'rgba(100,116,139,.40)'},floating:{glassEdge:'rgba(100,116,139,.34)'}}}}
    }
  }));
