(() => {
  ...
  const resourceRows=()=>[
    ...
    {uri:'dkds://sdk',name:'SDK authoring reference',description:'Packaged SDK 1.20.0 / Plugin API 1.18.0 / Theme Contract 3.8.0 authoring corpus summary for autonomous plugin development.',mimeType:'application/json'},
