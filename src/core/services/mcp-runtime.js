(() => {
  ...
  const resourceRows=()=>[
    ...
    {uri:'dkds://sdk',name:'SDK authoring reference',description:'Packaged SDK 1.18.0 / Plugin API authoring corpus summary for autonomous plugin development.',mimeType:'application/json'},
