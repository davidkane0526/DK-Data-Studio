(() => {
  ...
  const resourceRows=()=>[
    ...
    {uri:'dkds://sdk',name:'SDK authoring reference',description:'Packaged SDK 1.27.0 / Plugin API 1.19.0 / Theme Contract 3.10.0 authoring corpus summary for autonomous plugin development.',mimeType:'application/json'},
