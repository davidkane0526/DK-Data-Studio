(() => {
  ...
  const resourceRows=()=>[
    ...
    {uri:'dkds://sdk',name:'SDK authoring reference',description:'Packaged SDK 1.22.1 / Plugin API 1.18.0 / Theme Contract 3.9.0 authoring corpus summary for autonomous plugin development.',mimeType:'application/json'},
