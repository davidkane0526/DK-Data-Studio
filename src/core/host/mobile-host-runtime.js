(() => {
  ...
  function snapshot(){
    ...
    return {
      ...
      themeAppearance:window.DKDSTheme?.appearanceRoles?.()||{roles:{},components:{}},
      themeComponents:window.DKDSTheme?.appearanceComponents?.()||{},
      themeConsumption:window.DKDSTheme?.consumption?.()||{version:'0.0.0',components:{}},
      themeScientific:window.DKDSTheme?.scientific?.()||{seriesPalette:[],mode:'fallback-only',precedence:[]},
