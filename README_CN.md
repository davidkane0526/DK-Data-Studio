# DK Data Studio — v3.61.41

## v3.61.41 D3 默认悬浮工具栏内边距与居中修正

- D3 数据图默认悬浮工具栏继续保持更矮的 **20 px** 按钮高度，但恢复此前的横向尺寸：按钮宽度 **23 px**、拖动手柄宽度 **11 px**、外壳左右内边距 **2 px**。
- 本次只压缩上下高度，不再缩窄左右宽度；SDK 仍为 **1.17.6**，Plugin API 仍为 **1.17.0**。
