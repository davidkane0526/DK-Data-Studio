...
assert(contract.pluginApiVersion==='1.17.0'&&contract.minimumAppVersion==='3.61.33','Current complete SDK contract must require app 3.61.32 while preserving older installed plugin-package compatibility.');
