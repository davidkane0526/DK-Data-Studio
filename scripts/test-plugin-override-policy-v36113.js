...
const overrides=[
  ...
  {manifest:{id:'builtin.data-center',version:'1.13.5'},token:'newer'},
...
assert(policy.isNewerThanBuiltin({manifest:{version:'1.13.5'}},'1.13.2')===true,'Newer override version must be accepted.');
