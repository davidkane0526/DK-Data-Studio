...
(async()=>{
  ...
  const runtime=await feature.createTop({project:{datasets:[{path:'dataset',name:'dataset',vg:0,points:[{v:0,i:0}],sweeps}],peaks,gateAnalysisSettings:{featureMetric:'fwhm',featureDirection:'all'}},artifacts:{list:()=>[]},algorithms,pipeline,setStatus(){},scheduleSnapshot(){},copyTextToClipboard(){},savePlotlyImage(){}});
