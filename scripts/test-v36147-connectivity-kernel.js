...
assert.equal(pkg.version,'3.61.47','Connectivity/kernel release must be 3.61.47.');
...
(async()=>{
  ...
  console.log('v3.61.47 full-kernel AI/MCP, SMB/SAF and low-line UI contracts passed.');
