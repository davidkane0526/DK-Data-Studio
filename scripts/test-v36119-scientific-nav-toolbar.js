...
assert(json('package.json').version==='3.61.38','Application version must be 3.61.20.');
...
assert(css.includes('width:20px;height:20px')&&css.includes('width:10px;height:20px'),'Core D3 navigation chrome must use the reduced compact geometry.');
assert(sdk.pluginApiVersion==='1.17.0'&&sdk.minimumAppVersion==='3.61.38','Internal D3 navigation polish must not change the Plugin SDK current SDK contract and hardened host minimum.');
