...
assert(json('package.json').version==='3.61.29','Application version must be 3.61.20.');
...
assert(sdk.pluginApiVersion==='1.16.0'&&sdk.minimumAppVersion==='3.61.29','Internal D3 navigation polish must not change the Plugin SDK current SDK contract and hardened host minimum.');
