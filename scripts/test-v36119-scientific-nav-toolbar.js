...
assert(json('package.json').version==='3.61.35','Application version must be 3.61.20.');
...
assert(sdk.pluginApiVersion==='1.17.0'&&sdk.minimumAppVersion==='3.61.35','Internal D3 navigation polish must not change the Plugin SDK current SDK contract and hardened host minimum.');
