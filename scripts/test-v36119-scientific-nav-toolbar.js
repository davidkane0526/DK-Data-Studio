...
assert(json('package.json').version==='3.61.40','Application version must be 3.61.20.');
...
assert(css.includes('padding:1px 2px')&&css.includes('width:23px;height:20px;min-width:23px')&&css.includes('width:11px;height:20px;flex:0 0 11px'),'Core D3 navigation chrome must keep the reduced vertical height while preserving the previous horizontal width.');
