...
assert(pkg.version==='3.61.45','Application version must be v3.61.18.');
...
assert(schema.properties.apiVersion.enum.includes('1.16.0'),'SDK manifest schema must accept Plugin API 1.14.');
