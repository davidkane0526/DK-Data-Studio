...
assert(json('package.json').version==='3.61.20','Application version must be 3.61.18.');
...
assert(automation.includes("const VERSION='1.22.0'"),'Automation runner must identify the v3.61.18 contract diagnostics.');
