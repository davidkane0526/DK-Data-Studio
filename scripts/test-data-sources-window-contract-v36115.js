...
assert(json('package.json').version==='3.61.15','Application version must be 3.61.15.');
...
assert(automation.includes("const VERSION='1.19.0'"),'Automation runner must identify the v3.61.15 contract diagnostics.');
...
(async()=>{
  ...
  console.log('v3.61.15 dedicated TOP data.sources synchronous-read contract checks passed.');
