...
assert.equal(json('package.json').version,'3.61.46');
...
assert(app.includes("version:'3.61.46'")&&app.includes("appVersion:'3.61.46'"),'Main renderer version metadata must match the release version.');
assert(index.includes('<span class="version">v3.61.46</span>'),'Visible shell version must match the release version.');
assert(pluginWindow.includes("appVersion:'3.61.46'"),'Dedicated plugin windows must report the release version.');
