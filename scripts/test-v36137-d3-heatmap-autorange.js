...
assert(css.includes('width:10px;height:20px;flex:0 0 10px')&&css.includes('width:20px;height:20px;min-width:20px'),'Scientific floating navigation chrome must use the reduced 20 px control height.');
