...
assert(ui.includes('dkds-scientific-width-handle')&&ui.includes('onWidthWindowCommit')&&feature.includes('onWidthWindowCommit')&&feature.includes('windowLeft')&&feature.includes('windowRight'),'Core must own editable width handles and atomic full-window commits while Resonance supplies only peak-width domain semantics.');
