...
assert(/const VERSION='1\.[6-9]\.0'/.test(charts)&&charts.includes('function ensurePlotly(options={})')&&charts.includes('plotlyPromise'),'Core Chart Runtime v1.6+ must own one shared lazy Plotly loader promise.');
