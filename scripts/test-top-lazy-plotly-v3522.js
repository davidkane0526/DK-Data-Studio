...
assert(charts.includes("const VERSION='1.5.0'")&&charts.includes('function ensurePlotly(options={})')&&charts.includes('plotlyPromise'),'Core Chart Runtime v1.5.0 must own one shared lazy Plotly loader promise.');
