...
assert(kernel.includes("const API_VERSION = '1.10.0'"),'Plugin API must be v1.10.0.');
...
for(const [folder,{prime}] of Object.entries(migrated)){
  ...
  assert(['1.9.0','1.10.0'].includes(manifest.apiVersion),`${folder}: manifest must target compatible plugin API 1.9/1.10.`);
