...
assert(perf&&perf.VERSION==='1.1.0','Performance Runtime v1.1.0 must load.');
...
console.log('v3.48 cache budget, stage contract and hidden lifecycle trim checks passed.');
