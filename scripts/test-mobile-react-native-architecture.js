...
assert(shell.includes('surfaceHover: string;') && shell.includes("surfaceHover: '#2d3745'") && shell.includes("surfaceHover: '#e9f0f8'"), 'mobile Palette must declare and populate surfaceHover so project delete press feedback passes TypeScript');
