...
assert(json('package.json').version==='3.61.31','Application version must be v3.61.18.');
assert(json('sdk/contract.json').pluginApiVersion==='1.16.0','Standalone SDK must publish Plugin API 1.16.');
