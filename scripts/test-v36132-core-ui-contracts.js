...
const main=read('main.js'),preload=read('preload.js'),app=read('src/app.js'),status=read('src/plugins/status-monitor/plugin.js'),pluginWindow=read('src/plugin-window/runtime.js');
