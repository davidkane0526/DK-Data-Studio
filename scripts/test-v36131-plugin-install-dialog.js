...
assert.equal(pkg.version,'3.61.32','v3.61.32 source version must be synchronized.');
assert.equal(sdk.pluginApiVersion,'1.16.0','Plugin SDK contract must remain API 1.16.0.');
