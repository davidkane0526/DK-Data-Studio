...
Current implementation baseline: v3.67.51  
Plugin API: 1.19.0  
Current SDK: 1.27.0
...
- Native Mobile plugin-canvas splitters opt into `mobile-split-performance.js`, which caches drag-session geometry and coalesces raw pointer movement. The shared `layout/workspace.js` stays on the Desktop freeze hash.
