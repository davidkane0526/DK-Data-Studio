(() => {
  const manifest={
    id:'com.dkds.transfer-vth-lab',name:'Transfer Curve Vth Lab',version:'3.0.2',apiVersion:'1.16.0',entry:'plugin.js',scripts:['plugin.js'],styles:['plugin.css'],enabled:true,order:420,
    ...
    compatibility:{app:'>=3.61.32 <4.0.0',pluginApi:'^1.16.0'}
  };
  DKDSPlugins.define(manifest, async ctx => {
    ...
    workbench=ctx.ui.pluginWorkspace.create(host,{header:false,activity:'transfer-vth-lab',primaryScroll:'safe',canvasLeftWidth:300});
