...
A Plugin API 1.16 external TOP workbench reference implementation.
...
- Migrated to Plugin API 1.16 layout safety: `primaryScroll: "safe"`, no workspace `overflow:hidden`, and no plugin-owned viewport clipping.
