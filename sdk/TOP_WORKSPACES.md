...
Plugin API 1.19 validates the bounded layout before packaging. Core also owns a runtime Layout Guard: semantic containers that actually clip content are converted to scrolling, and ScientificCurveSurface treats `minWidth/minHeight` as preferred geometry rather than a silent-render gate.
