...
export interface DKDSUnitTemplateRuntime {
  ...
  readonly field:{create(host:Element|string,spec?:DKDSUnitFieldSpec):Readonly<{element:HTMLElement;label:HTMLElement|null;labelRow?:HTMLElement|null;unit?:HTMLElement|null;control:HTMLInputElement|HTMLSelectElement|HTMLTextAreaElement}>};
