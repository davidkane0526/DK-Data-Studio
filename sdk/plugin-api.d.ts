...
export interface DKDSPluginContext {
  readonly apiVersion:'1.8.0'; readonly manifest:Readonly<DKDSManifest>;
  ...
  readonly ui:{
    ...
    scientificPlot:any; plotViews:any; selection:any; interaction:any; interactions:any; contextMenus:any;
