(() => {
  ...
  DKDSPlugins.define({
    id:'com.example.workspace',pluginType:'workbench',name:'SDK Workspace Example',version:'1.0.0',apiVersion:'1.17.0',entry:'plugin.js',scripts:['plugin.js'],enabled:true,order:900,
    ...
    compatibility:{app:'>=3.61.37 <4.0.0',pluginApi:'^1.17.0'}
  }, async ctx => {
