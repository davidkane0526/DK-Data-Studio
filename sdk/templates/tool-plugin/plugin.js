(() => {
  const manifest={
    id:'com.example.tool-workspace',name:'SDK Tool Workspace Example',version:'1.0.0',apiVersion:'1.17.0',entry:'plugin.js',scripts:['plugin.js'],styles:['plugin.css'],enabled:true,order:920,
  ...
  DKDSPlugins.define(manifest, async ctx => {
    ...
    workspace=ctx.ui.pluginWorkspace.create(host,{header:false,activity:'sdk-tool-example',primaryScroll:'safe'});
