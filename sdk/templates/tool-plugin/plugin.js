(() => {
  const manifest={
  "id": "com.example.tool-workspace",
  "name": "SDK Tool Workspace Example",
  "version": "1.0.0",
  "apiVersion": "1.19.0",
  "entry": "plugin.js",
  "scripts": [
  ...
  "enabled": true,
  "order": 920,
  "description": "Tool Workspace using the same dedicated-window contract as TOP, grouped under the Core Tools button.",
  "pluginType": "tool",
  "requiresCore": [
    "workspace",
    "ui.dom",
  ...
  "workspace": {
    "role": "top",
    "activity": "sdk-tool-example",
    "icon": "⌁",
    "title": "SDK Tool Example"
  },
  "window": {
    "activity": "sdk-tool-example",
    "title": "SDK Tool Example",
  ...
  DKDSPlugins.define(manifest, async ctx => {
    ...
    const page=ctx.ui.pages.add({id:'sdk-tool-example-page',pageId:'sdkToolExamplePage',activity:'sdk-tool-example',label:'SDK Tool',title:'SDK Tool Workspace Example',toolbar:false,html:'<div class="analysis-page-header"><div><h2>SDK Tool Workspace Example</h2><div class="sdk-tool-subtitle dkds-meta">Tool category · TOP-equivalent lifecycle · Tools-menu entry</div></div></div><div class="analysis-page-body"><div class="sdk-tool-workbench"></div></div>'});
