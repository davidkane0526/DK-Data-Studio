(() => {
  const manifest={
    id:'com.example.tool-workspace',name:'SDK Tool Workspace Example',version:'1.0.0',apiVersion:'1.16.0',entry:'plugin.js',scripts:['plugin.js'],styles:['plugin.css'],enabled:true,order:920,
