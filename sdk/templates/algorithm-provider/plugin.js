(() => {
  ...
  DKDSPlugins.define({
    id:'com.example.algorithm-provider',pluginType:'algorithm',name:'SDK Algorithm Provider Example',version:'1.0.0',apiVersion:'1.11.0',entry:'plugin.js',scripts:['plugin.js'],enabled:true,
    ...
    compatibility:{app:'>=3.61.4 <4.0.0',pluginApi:'^1.11.0'}
  }, async ctx => {
