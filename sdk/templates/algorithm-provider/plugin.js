(() => {
  ...
  DKDSPlugins.define({
    id:'com.example.algorithm-provider',name:'SDK Algorithm Provider Example',version:'1.0.0',apiVersion:'1.9.0',entry:'plugin.js',scripts:['plugin.js'],enabled:true,
    ...
    compatibility:{app:'>=3.59.0 <4.0.0',pluginApi:'^1.9.0'}
  }, async ctx => {
