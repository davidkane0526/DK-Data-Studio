(() => {
  ...
  DKDSPlugins.define({
    id:'com.example.algorithm-provider',pluginType:'algorithm',name:'SDK Algorithm Provider Example',version:'1.0.0',apiVersion:'1.15.0',entry:'plugin.js',scripts:['plugin.js'],enabled:true,
