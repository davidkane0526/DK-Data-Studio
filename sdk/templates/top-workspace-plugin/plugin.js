(() => {
  const manifest={
    id:'com.example.top-workspace',name:'SDK TOP Workspace Example',version:'1.0.0',apiVersion:'1.18.0',entry:'plugin.js',scripts:['plugin.js'],styles:['plugin.css'],enabled:true,order:910,
    ...
    data:{accepts:['science.transport.iv']},compatibility:{app:'>=3.62.0 <4.0.0',pluginApi:'^1.18.0'}
  };
