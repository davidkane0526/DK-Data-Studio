(() => {
  const manifest={
    id:'com.example.top-workspace',name:'SDK TOP Workspace Example',version:'1.0.0',apiVersion:'1.19.0',entry:'plugin.js',scripts:['plugin.js'],styles:['plugin.css'],enabled:true,order:910,
    ...
    data:{accepts:['science.transport.iv']},compatibility:{app:'>=3.67.5 <4.0.0',pluginApi:'^1.19.0'}
  };
